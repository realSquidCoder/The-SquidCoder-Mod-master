...
import com.SquidCoder.squidcoder.data.custom.blocks.custom.OxidationLevel;
import com.SquidCoder.squidcoder.data.custom.blocks.custom.OxidizingBlock3;
import com.SquidCoder.squidcoder.data.custom.blocks.custom.ShipwrightsTableBlock;
import com.SquidCoder.squidcoder.data.custom.items.ModItemGroup;
import com.SquidCoder.squidcoder.data.custom.sounds.ModSoundType;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> SHIPWRIGHTS_TABLE = register("shipwrights_table",
            () -> new ShipwrightsTableBlock(AbstractBlock.Properties.copy(Blocks.CRAFTING_TABLE)));
    /*
    public static final RegistryObject<Block> BOAT_BUILDER = register("boat_builder",
            () -> new ShipwrightsTableBlock(AbstractBlock.Properties
                    .of(Material.METAL)
                    .strength(5f, 6f)
                    .harvestTool(ToolType.PICKAXE)
                    .sound(SoundType.METAL)));
